...
<!-- container section start -->
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="<?= base_url('');?>index.php/Welcome" class="logo">Control <span class="lite">Nivel de agua</span></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
            <a class="" href="<?= base_url('');?>index.php/Welcome">
      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="info-box">
              <center>
                    <img src="<?= base_url('');?>/img/ups.png" width="50%"><br><br>
                    <div class="count" style="color:black">
                        PROYECTO CONTROL DE NIVEL DE AGUA<br><br>
                        INTEGRANTES:<br><br>
                    </div>
                    <div class="title" style="color:black">Diego Piedra<br><br>Washington Atupaña<br></div>
              </center>
              </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box dark-bg">
              ...
              <div class="count"><a style="color:white" href="<?= base_url('');?>index.php/registro">Registrarse</a></div>
            </div>
            <!--/.info-box-->
          </div>
          ...
          <div class="col-lg-6">
            <div class="info-box dark-bg">
              <i class="fa fa-link"></i>
              <div class="count"><a style="color:white" href="<?= base_url('');?>index.php/login">Iniciar Sesión</a></div>
            </div>
            <!--/.info-box-->
          </div>
        </div>
